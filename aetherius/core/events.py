...
class PlayerDeathEvent(PlayerEvent):
    ...
    killer: Optional[str] = Field(default=None, description="Name of killer if applicable")
...
class LogLineEvent(SystemEvent):
    ...
    timestamp: Optional[datetime] = Field(default=None, description="Parsed timestamp from log")
...
class TickTimeEvent(PerformanceEvent):
    ...
    warning_threshold: float = Field(default=50.0, description="Warning threshold in ms")
