...
from ..core import (
    ...
    ServerStartedEvent, ServerStoppedEvent, ServerCrashEvent, LogLineEvent
)
from ..plugins import PluginManager
from ..components import ComponentManager
>>>>>>> 3525cdf1073a036e878cce96c01e8240c5a28403
...
>>>>>>> 3525cdf1073a036e878cce96c01e8240c5a28403
    ...
    async def handle_log_line(event: LogLineEvent):
        ...
        if event.level in ["WARN", "ERROR"]:
            ...
            console.print(f"[{level_color}][{event.level}][/{level_color}] {event.message}")
...
>>>>>>> 3525cdf1073a036e878cce96c01e8240c5a28403
    ...
    background: bool = typer.Option(
        True, "--background/--foreground", "-b/-f", help="Run server in background (default) or foreground"
    )
) -> None:
...
=======
    ...
    async def start_server():
        ...
        if success:
            ...
            if background:
                console.print("[dim]Server is running in background. Use 'aetherius console' to monitor or 'aetherius server stop' to stop.[/dim]")
            else:
...
>>>>>>> 3525cdf1073a036e878cce96c01e8240c5a28403
        ...
        if server_info:
            ...
            pid_info = f"PID: {server.process.pid}" if server.process else "PID: Unknown"
            memory_info = ""
            cpu_info = ""
            start_time = ""
    else:
