...
from .plugin import Plugin, PluginInfo, PluginContext, SimplePlugin
...
class PluginManager:
    ...
    async def _load_plugin_module(self, plugin_name: str, plugin_info: PluginInfo) -> Optional[Plugin]:
    ...
    def _create_plugin_instance(self, module: Any, plugin_info: PluginInfo) -> Optional[Plugin]:
        ...
        logger.warning(f"No plugin class or hooks found in module")
        return simple_plugin
