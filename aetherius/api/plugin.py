...
class PluginInfo(BaseModel):
    ...
    soft_depends: List[str] = Field(default_factory=list, description="Optional plugins")
    
    # Compatibility
    api_version: str = Field(default="0.1.0", description="Required Aetherius API version")
    minecraft_versions: List[str] = Field(default_factory=list, description="Supported MC versions")
